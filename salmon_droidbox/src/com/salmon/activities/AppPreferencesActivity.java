...
public class AppPreferencesActivity extends PreferenceActivity {
	...
	private PreferenceScreen createPreferenceHierarchy() {
        ...
        AppPrefCat.addPreference(screenPOIcolor);
        	...
        	colorHandicapPOI.setEntries(new CharSequence[] {"Red","Orange","Yellow","Green","Blue","Purple","Black"});
        	colorHandicapPOI.setEntryValues(new CharSequence[] {"disability_red.png","disability_orange.png","disability_yellow.png","disability_green.png","disability_blue.png","disability_purple.png","disability_black.png"});
	        ...
	        colorRestroomsPOI.setEntries(new CharSequence[] {"Red","Orange","Yellow","Green","Blue","Purple","Black"});
	        colorRestroomsPOI.setEntryValues(new CharSequence[] {"toilets_red.png","toilets_orange.png","toilets_yellow.png","toilets_green.png","toilets_blue.png","toilets_purple.png","toilets_black.png"});
	        ...
	        colorInfoPOI.setEntries(new CharSequence[] {"Red","Orange","Yellow","Green","Blue","Purple","Black"});
	        colorInfoPOI.setEntryValues(new CharSequence[] {"information_red.png","information_orange.png","information_yellow.png","information_green.png","information_blue.png","information_purple.png","information_black.png"});
	        ...
	        colorReceptionPOI.setEntries(new CharSequence[] {"Red","Orange","Yellow","Green","Blue","Purple","Black"});
	        colorReceptionPOI.setEntryValues(new CharSequence[] {"waiting_red.png","waiting_orange.png","waiting_yellow.png","waiting_green.png","waiting_blue.png","waiting_purple.png","waiting_black.png"});
	        ...
	        colorStairsPOI.setEntries(new CharSequence[] {"Red","Orange","Yellow","Green","Blue","Purple","Black"});
	        colorStairsPOI.setEntryValues(new CharSequence[] {"stairs_red.png","stairs_orange.png","stairs_yellow.png","stairs_green.png","stairs_blue.png","stairs_purple.png","stairs_black.png"});
	        ...
	        colorElevatorPOI.setEntries(new CharSequence[] {"Red","Orange","Yellow","Green","Blue","Purple","Black"});
	        colorElevatorPOI.setEntryValues(new CharSequence[] {"elevator_red.png","elevator_orange.png","elevator_yellow.png","elevator_green.png","elevator_blue.png","elevator_purple.png","elevator_black.png"});
	        ...
	        colorExitPOI.setEntries(new CharSequence[] {"Red","Orange","Yellow","Green","Blue","Purple","Black"});
	        colorExitPOI.setEntryValues(new CharSequence[] {"exit_red.png","exit_orange.png","exit_yellow.png","exit_green.png","exit_blue.png","exit_purple.png","exit_black.png"});
        ...
        // Include Hallways
        CheckBoxPreference hallwayPref = new CheckBoxPreference(this);
        hallwayPref.setKey(AppPrefs.PREFERENCE_INCLUDE_HALLWAYS);
        hallwayPref.setTitle("Hallways");
        hallwayPref.setSummary("Include hallway points as possible destinations");
        verbosePref.setDefaultValue(false);
        AppPrefCat.addPreference(hallwayPref);
