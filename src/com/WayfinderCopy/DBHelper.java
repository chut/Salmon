...
public class DBHelper extends SQLiteOpenHelper{
	...
	private static String PACKAGE = "com.WayfinderCopy";
...
//////////////////SQL SELECT STATEMENTS/////////////////////////
	...
	public int getNodeFloor(String nID){
		...
		Log.v("getPosition", Integer.toString(q.getPosition()));
		Log.v("getCount", Integer.toString(q.getCount()));
		
		if(q.moveToFirst()){
			Log.v("CURSOR", "moved to first");
			out = q.getInt(0);
			Log.v("floor", Integer.toString(out));
		}else Log.v("CURSOR", "could be null");
		q.close();
		return out;
	}
